...
export const InsurancePacks = [
  {
    id: 1,
    title: "Auto Prestige",
    desc: "Vous assurer rapidement, c'est possible!! \n Faites une simulation, obtenez votre tarif Auto, souscrivez en quelques clics et faites vous livrer gratuitement.",
  ...
  },
  {
    ...
    desc: "Couverture des frais médicaux (consultation, Analyses, Radio, Hospitalisation). des frais de maternité (prénatale et post natale, Accouchement), des frais d'évacuations sanitaires à l'étranger etc ...",
    type: "Produit",
    icon: require("../../assets/icons/sante.png"),
    color: COLORS[2],
    coverage: [
      "Couverture des frais médicaux (consultation, Analyses, Radio, Hospitalisation)",
      "Des frais de maternité (prénatale et post natale, Accouchement)",
      "Des frais d'évacuations sanitaires à l'étranger (Au cas où la maladie ne pourrait pas être traitée sur place)",
      "Des frais chirurgicaux / Rapatriement du corps",
    ],
    bg: require("../../assets/carsbg.png"),
  },
  {
    ...
    desc: "Pour tous vos déplacements à l'étranger, bénéficiez en cas d'urgence d'une assurance médicale",
    icon: require("../../assets/icons/travel.png"),
    type: "Produit",
    color: COLORS[3],
    coverage: [
      "Prise en charge des frais médicaux, Hospitalisations, Analyses, Radio,consultation",
  ...
  {
    id: 5,
    title: "Assurance Transport de marchandises et Aviations",
    desc: "Ne vous souciez plus du transport domestique ou international de vos marchandises. Selon la garantie souscrite (tous Risques, FAP sauf, accidents Caractérisés ou Evènements majeurs), bénéficiez:",
    icon: require("../../assets/icons/transport.png"),
    type: "Produit",
    color: COLORS[0],
    coverage: [
      "d'une indemnisation en cas de surve-nance d'avaries ou de vol ",
      "nous disposons égale-ment de solutions d'assurance pour les risques liés à l'aviation en collaboration avec un solide réseau de partenaires internationaux",
  ...
  },
  {
    ...
    desc: "Nos offres d'assurance concernent les travaux de construction,les machines et équipements indus-triels, les appareils électroniques et informatiques. Souscrivez selon votre besoin à l'assurance : ",
    icon: require("../../assets/icons/toolbox.png"),
    type: "Produit",
    color: COLORS[1],
    coverage: [
      "Tous risques chantier /Tous Risques montage/ Responsabilité Civile Décennale.",
      "Bris de machine",
